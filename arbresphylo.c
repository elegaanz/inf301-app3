...
int est_feuille(arbre a) { return ((a->droit == NULL) && (a->gauche == NULL)); }
...
int ajouter_espece(arbre *a, char *espece, cellule_t *seq) {
    ...
    if (arb == NULL) {
        ...
        *a = malloc(sizeof(noeud));
        ...
        printf("Ne peut ajouter %s: déjà présente dans l'arbre.\n", espece);
        return 1;
    } else {
...
resultat_clade trouve_clade(arbre arb, cellule_t *liste_especes, arbre parent,
                            int depth) {
    ...
    if (inclusion(liste_especes, l)) {
        if (inclusion(l, liste_especes)) {
            ...
            resultat_clade res1 =
                trouve_clade(arb->gauche, liste_especes, arb, depth + 1);
            resultat_clade res2 =
                trouve_clade(arb->gauche, liste_especes, arb, depth + 1);
